...
step2: Iterate array from last to first. In an iteration first takee w last num of array
comparith stack elements until the top of stack is less than the element then add 
